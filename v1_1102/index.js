...
var APP_ID = "amzn1.ask.skill.d2ce687c-45ae-43f5-b556-52953b32c355"; // TODO replace with your app ID (OPTIONAL).
...
// Questions
var nodes = [{ "node": 1, "message": "When you’re about to start a project, do you jump right in, or would you rather hide under the bed?", "Jump right in": 2},
             { "node": 2, "message": "Okay, and do you have a good idea of what you want your room to look like? Yes or no?", "yes": 3 },
             { "node": 3, "message": "Got it. And do you want your home to feel more bold and unique or calm and coordinated?", "bold and unique.": 4},
             { "node": 4, "message": "Good choice. Last question for you. Take a look at the screen — which of these homes puts the biggest smile on your face? ", "home one": 10},
            

            // Answers & descriptions

             { "node": 10, "message": "Nice! Okay, based on your answers, it looks like you’re a real Rebel with a Roller. You don’t follow trends, you make your own. That means Valspar is the right paint for you. ", "yes": 0, "no": 0, "description": "A physician or medical doctor is a professional who practices medicine." },
...
var welcomeMessage = "Welcome to Paintbot. Picking a paint depends on the painter. So, let’s start with a few questions. ";

// This is the message that is repeated if the response to the initial welcome message is not heard
var repeatWelcomeMessage = "Say yes to start Paint Picker or no to quit.";
...
var promptToStartMessage = "Welcome to Paintbot. Picking a paint depends on the painter. So, let’s start with a few questions. Are you ready to begin? ";
...
var utterancePlayAgain = "ask again";
...
var askQuestionHandlers = Alexa.CreateStateHandler(states.ASKMODE, {
    ...
    'JumpRightIn_Intent': function () {
        // Handle Yes intent.
        helper.jumpRightIn(this,'jump right in');
    },
});
...
var helper = {
    ...
    // jumpRightIn
    jumpRightIn: function (context, reply) {
    ...
    // gets the next node to traverse to based on the yes no response
    getNextNode2: function (nodeId, yesNo) {
        for (var i = 0; i < nodes.length; i++) {
            if (nodes[i].node == nodeId) {
                if (yesNo == "jump riught in") {
                    return nodes[i].yes;
                }
                return nodes[i].no;
            }
