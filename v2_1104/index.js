...
const handlers = {
    'LaunchRequest': function () {
        ...
        // // let listItem1 = builder.setTextContent(makePlainText('img1')).setImage(makeImage('https://s3.amazonaws.com/deutscherlookup/home1.jpg', 400, 600)).build(); 
        // // let listItem2 = builder.setTextContent(makePlainText('img2')).setImage(makeImage('https://s3.amazonaws.com/deutscherlookup/home2.jpg', 400, 600)).build(); 

        // // var img1 = 'https://s3.amazonaws.com/deutscherlookup/home1.jpg';
        // // var img2 = 'https://s3.amazonaws.com/deutscherlookup/home2.jpg';
        // let template = builder.setTitle('HGTV + Valspar').setImage(makeImage('https://s3.amazonaws.com/deutscherlookup/home1.jpg', 400, 600)).setTextContent(makePlainText('Hello! Welcome to Paintbot.')).setBackButtonBehavior("HIDDEN").build();
...
//     var cardBody = "this is body";
//     var imageObj = {
//         smallImageUrl: "https://s3.amazonaws.com/deutscherlookup/home2.jpg",
//         largeImageUrl: "https://s3.amazonaws.com/deutscherlookup/home2.jpg"
//     };
//     // SMALL = 720w x 480h, LARGE = 1200w x 800h
//     return {
//         "title": cardTitle,
